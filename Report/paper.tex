...
\begin{figure}
	\begin{center}
		...
		% \includegraphics[width=0.3\columnwidth]{figs/sizes_test.pdf}
...
\input{table_best_predicted.tex}
...
\input{table_worst_predicted.tex}
...
\begin{figure}
	...
	\includegraphics[width=0.18\columnwidth]{conffigs/usion_matrix_TheBackpropagatedStubborns.png}\\
	...
	\includegraphics[width=0.18\columnwidth]{conffigs/usion_matrix_ResMetz.png}\\
